          ...
          <div className="flex flex-col items-center justify-center py-20 h-full">
            ...
            <div className="flex flex-col items-center mt-8 max-w-4xl w-11/12 md:w-full">
              <h1 className="text-4xl md:text-6xl lg:textxl md:!leading-snug font-semibold text-center bg-clip-text bg-gradient-to-b from-gray-50 to-gray-50 text-transparent">
                Transform Your IEEE Workshop Experience
              </h1>
              <p className="text-base md:text-lg text-foreground/80 mt-6 text-center">
                Enhance your workshop experience with the IEEE Workshop
                Companion Platform. Manage schedules, engage in real-time Q&A,
                and ensure seamless communication for enriched participation.
              </p>
              <div className="hidden md:flex relative items-center justify-center mt-8 md:mt-12 w-full">
                ...
                >
                  <p className="text-foreground text-sm text-center md:text-base font-medium pl-4 pr-4 lg:pr-0">
                    ✨ {"  "} Connect, Engage, and Elevate Your Workshop
                    Interactions
                  </p>
                  <Button
                    size="sm"
        ...
        <Container>
          <div className="max-w-2xl mx-auto text-start md:text-center">
            ...
            <h2 className="text-3xl lg:text-5xl font-semibold mt-6">
              Effortless Engagement in Three Simple Steps
            </h2>
            <p className="text-muted-foreground mt-6">
              Seamlessly Connect and Engage in Just 3 Steps
            </p>
          </div>
        </Container>
        <Container>
        ...
        <Container>
          <div className="max-w-2xl mx-auto text-start md:text-center">
            ...
            <h2 className="text-3xl lg:text-4xl font-semibold mt-6">
              Powerful Features for a Seamless Workshop Experience
            </h2>
            <p className="text-muted-foreground mt-6">
              Unlock the full potential of your event with tools designed to
              engage, organize, and enhance every session.
            </p>
          </div>
        </Container>
